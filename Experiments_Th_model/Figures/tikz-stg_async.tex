\begin{tikzpicture}
	...
	%g2
	\draw[stgedge] (000) edge (010);
	\draw[stgedge] (100) edge (110);
	\draw[stgedge] (011) edge (001);
	\draw[stgedge] (111) edge (101);
	%g3
	\draw[stgedge] (000) edge (001);
	\draw[stgedge] (100) edge (101);
	\draw[stgedge] (011) edge (010);
	\draw[stgedge] (111) edge (110);
\end{tikzpicture}
